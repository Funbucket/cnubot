...
<body class="__PAGE_MODE__"><main class="shell"><header><div><span class="eyebrow">CNU EXPERIMENT LAB</span><h1>실험실</h1><p class="sub">가설을 검증하고, 학습을 기록하세요.</p></div><div><nav class="admin-nav" aria-label="관리자 메뉴"><a href="/admin/recommendations">상품·버튼 관리</a><a href="/admin/insights">인사이트</a><a href="/admin/experiments" aria-current="page">실험실</a></nav><div class="notice">결정 전 샘플 수와 SRM을 확인하세요.</div></div></header>
