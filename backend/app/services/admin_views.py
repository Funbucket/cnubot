...
</style><main><header><div><span class="eyebrow">RECOMMENDATION CENTER</span><h1>개인화 추천</h1><p class="sub">사용자 반응을 바탕으로 다음에 보여줄 상품을 관리합니다.</p></div><nav class="admin-nav" aria-label="관리자 메뉴"><a href="/admin/recommendations" aria-current="page">상품·버튼 관리</a><a href="/admin/insights">인사이트</a><a href="/admin/experiments">실험실</a><a href="/admin/events">이벤트 수집</a></nav></header>
...
<body class="admin-unified admin-experiments __PAGE_MODE__"><link rel="stylesheet" href="/admin/assets/admin_nav.css"><header class="admin-topbar"><a class="admin-brand" href="/admin"><span class="admin-brand-mark">C</span>CNU ADMIN</a><nav class="admin-nav" aria-label="관리자 메뉴"><a href="/admin/recommendations">상품·버튼 관리</a><a href="/admin/insights">인사이트</a><a href="/admin/experiments" aria-current="page">실험실</a><a href="/admin/events">이벤트 수집</a></nav></header><main class="shell"><header class="admin-page-heading"><div><span class="eyebrow">CNU EXPERIMENT LAB</span><h1>실험실</h1><p class="sub">가설을 검증하고, 학습을 기록하세요.</p></div></header><div class="notice">결정 전 샘플 수와 SRM을 확인하세요.</div>
