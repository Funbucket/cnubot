...
from app.services import promotion_insights
from app.services.promotion_insights import (
    _PATH_EVENTS_CTE, _summarize_paths, _summarize_guardrails, _rate,
)
...
async def get_promotion_insights(start_date=None, end_date=None) -> dict[str, Any]:
    """Keep the service entry point while delegating dashboard aggregation."""
    return await promotion_insights.get_promotion_insights(get_pool(), start_date, end_date)
